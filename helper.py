...
def load_reader(
    ...
    if spatial_backbone == "stats" and satellite != "planet_daily":
        raise NotImplementedError

    planet_daily_csv_dir = f"{ivan_data_root}/{competition}/{train_or_test}/{pos}"

    s1_transform = Sentinel1Transform(include_rvi=include_rvi, **kwargs)
